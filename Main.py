...
main = tkinter.Tk()
main.title("DeepFood: Food Image Analysis and Dietary Assessment via Deep Model") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='DeepFood: Food Image Analysis and Dietary Assessment via Deep Model')
